"""
Efficient System - Continuous Microbatching
...
Deploy:
  modal deploy efficient_system.py
"""
...
class Model:
    ...
    class GPUReplica:
        ...
        def __init__(self, device_id: int):
            ...
            # NOTE: kept 4-bit as in your current code. For A100 throughput, bf16 often wins.
    ...
    def load_models(self):
        ...
        self._q = {
            0: {"mmlu": queue.Queue(maxsize=QUEUE_MAXSIZE), "infobench": queue.Queue(maxsize=QUEUE_MAXSIZE)},
            1: {"mmlu": queue.Queue(maxsize=QUEUE_MAXSIZE), "infobench": queue.Queue(maxsize=QUEUE_MAXSIZE)},
        }
